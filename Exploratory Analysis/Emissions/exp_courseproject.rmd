...
We use grep on the Short.Name variable to determine which SCC codes refer to coal combustion sources, then subset our NEI data using these codes. We look at only the data where the log lies between 0 and 2, which contains the bulk of the measurements
